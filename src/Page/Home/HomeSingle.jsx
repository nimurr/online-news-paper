...
export default function HomeSingle({ data }) {
    ...
    return (
        <div className="gap-4  shadow-blue-200/50 shadow-[0px_0px_10px]  rounded-md overflow-hidden justify-between">
             <img className="h-[50vh] w-full" src={img} alt="" />
            <div className=" flex bg-white flex-col justify-between p-4">
